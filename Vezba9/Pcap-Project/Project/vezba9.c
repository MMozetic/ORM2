...
//	queue_tcp = pcap_sendqueue_alloc(512*1024);
//	/**************************************************************/
...
//	{
//		printf("An error occurred sending the udp packets: %s. Only %d bytes were sent\n", pcap_geterr(device_handle_out), sentBytes);
//	}
//
//	Sleep(2000);
//
...
//	{
//		printf("An error occurred sending the tcp packets: %s. Only %d bytes were sent\n", pcap_geterr(device_handle_out), sentBytes);
//	}
//
//	/**************************************************************/
//	// Free queues 
